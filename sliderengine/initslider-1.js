jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        titlecss:"display:table; position:relative; font-weight:300; font-style:italic; font-size:40px; font-family:lobster,Arial; color:#fff; padding:10px; margin:0px auto;",
        ribbonimagey:0,
        ribbonimagex:0,
